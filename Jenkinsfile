...
podTemplate(label: 'blog-pod', nodeSelector: 'medium', containers: [
    ...
    node('blog-pod') {
        ...
        container('docker') {
                ...
                stage('build docker image'){
                    ...
                    sh "docker build -t registry.k8.wildwidewest.xyz/repository/docker-repository/pocs/blog:$now ."
                    ...
                    sh "docker push registry.k8.wildwidewest.xyz/repository/docker-repository/pocs/blog:$now"
